...
public class MainViewController {
    ...
    /**
     * Añade una viñeta flotante con informacion del arbol
     */
    private void addTooltipInformation(StackPane group) {
        String selected = comboTrees.getSelectionModel().getSelectedItem();
        BinaryTree selectTree = treeManager.getTree(selected);

        StringBuilder sb = new StringBuilder();
        sb.append("Altura: ").append(selectTree.getHeight())
            .append("\nNumero de nodos: ").append(selectTree.getSize())
            .append("\nNumero de hojas: ").append(selectTree.getLeavesSize())
            .append("\nValor maximo: ").append(selectTree.getMaxValue())
            .append("\nValor minimo: ").append(selectTree.getMinValue());

        Tooltip message = new Tooltip(sb.toString());
        Tooltip.install(group, message);
    }
